        ...
        while (!validEntry && scanner.hasNextLine() ) {
            ...
            if (line.isBlank())
                ...
                if (plateauSizeArr.length < 2) {
                    ...
                    plateau = pcontroller.createPlateau(Integer.parseInt(plateauSizeArr[0]), Integer.parseInt(plateauSizeArr[1]));
                    if (plateau != null) {
        ...
        while(scanner.hasNextLine()){
            ...
            if (line.isBlank())
                ...
                errorMessage = "Please enter valid values of the x , y and direction.";
                 ...
                 rover = rcontroller.createRover(Integer.parseInt(roverInitialArr[0]), Integer.parseInt(roverInitialArr[1]),roverInitialArr[1] );
                if (rover != null) {
